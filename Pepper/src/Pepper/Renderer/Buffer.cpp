...
Pepper::Ref<Pepper::VertexBuffer> Pepper::VertexBuffer::Create(float* vertices, uint32_t size, uint32_t parent)
{
...
Pepper::Ref<Pepper::IndexBuffer> Pepper::IndexBuffer::Create(uint32_t* indices, uint32_t count, uint32_t parent)
{
  switch (Renderer::GetAPI())
  {
  case RendererAPI::API::OPEN_GL:
