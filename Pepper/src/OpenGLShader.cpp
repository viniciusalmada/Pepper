...
namespace Pepper
{
  ...
  void OpenGLShader::SetFloat2(const std::string& uniformName, const glm::vec2& vec)
  {
    PP_PROFILE_FUNCTION();
    this->pimp->UploadUniformFloat2(uniformName, vec);
  }
  ...
  void OpenGLShader::Impl::UploadUniformMat3(const std::string& uniformName,
